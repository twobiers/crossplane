...
type initCmd struct {
	...
	Directory     string `default:"."                                                     help:"The directory to initialize. It must be empty. It will be created if it doesn't exist." short:"d" type:"path" predictor:"directory"`
